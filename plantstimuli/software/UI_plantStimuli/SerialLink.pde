...
Serial myPortController;                            // Create object from Serial class
...
void SerialControllerSetup() {
  myPortController = new Serial(this, Serial.list()[PortSelectedController], 9600);
  delay(50);
  myPortController.clear(); 
  myPortController.buffer(20);
}
...
public void sendCMD(int value) { 
  print(" VALUE: ");
  print(int(value));   
  
  //myPortController.write(cmd);  
  myPortController.write(int(value));
}
